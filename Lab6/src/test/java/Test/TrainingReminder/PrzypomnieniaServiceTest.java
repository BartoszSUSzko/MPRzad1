...
class PrzypomnieniaServiceTest {
    ...
    void powinnoWyslacPrzypomnienieTylkoDlaCertyfikatuWygasajacego() {
        ...
        WyslanePrzypomnienie przypomnienie = spyKom.getHistoria().get(0);
        assertEquals("@A", przypomnienie.getPracownik().getEmail());
        assertTrue(przypomnienie.getTresc().contains("BHP"));
    }
