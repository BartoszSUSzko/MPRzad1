...
public class ZespolTest {
    ...
    public void przeniesieniePracownikaDziala() {
        ...
        assertThat(zespol1.getNazwaZespolu().contains("zespol1"), is(true));
    }
    ...
    public void dodajPracownika(){
        Zespol zespol1 = new Zespol("zespol1", 5);
        assertThrows(IllegalArgumentException.class, () -> zespol1.dodajPracownika(null));
    }
    @Test
    public void dodajPracownikaktorytamjest(){
        Zespol zespol1 = new Zespol("zespol1", 5);
        Pracownik p1 = new Pracownik("Ktos", "Ktosowski", "@ktos", "FirmaA", Stanowiska.Programista);
        zespol1.dodajPracownika(p1);
        assertThrows(IllegalArgumentException.class, () -> zespol1.dodajPracownika(p1));
    }
    @Test
    public void dodajPracownikasizeprzekroczony(){
        Zespol zespol1 = new Zespol("zespol1", 1);
        Pracownik p1 = new Pracownik("Ktos", "Ktosowski", "@ktos", "FirmaA", Stanowiska.Programista);
        Pracownik p2 = new Pracownik("A","A","@A","FirmaA",Stanowiska.Prezes);
        zespol1.dodajPracownika(p1);
        assertThrows(IllegalArgumentException.class, () -> zespol1.dodajPracownika(p2));
    }

    @Test
    public void usunPracownika(){
        Zespol zespol1 = new Zespol("zespol1", 5);
        assertThrows(IllegalArgumentException.class, () -> zespol1.usunPracownika(null));
    }
    @Test
    public void usunPracownikaktoregoniema(){
        Zespol zespol1 = new Zespol("zespol1", 5);
        Pracownik p1 = new Pracownik("Ktos", "Ktosowski", "@ktos", "FirmaA", Stanowiska.Programista);
        assertThrows(IllegalArgumentException.class, () -> zespol1.usunPracownika(p1));
    }

    @Test
    public void przeniesPracownikaAlePracownikJestNull(){
        Zespol zespol1 = new Zespol("zespol1", 5);
        Zespol zespol2 = new Zespol("zespol2", 5);
        assertThrows(IllegalArgumentException.class, () -> zespolManager.przeniesPracownika(null,zespol2,zespol1));
    }

    @Test
    public void przeniesPracownikaaleZespolniemamiejsca(){
        Zespol zespol1 = new Zespol("zespol1", 5);
        Zespol zespol2 = new Zespol("zespol2", 1);
        Pracownik p1 = new Pracownik("Ktos", "Ktosowski", "@ktos", "FirmaA", Stanowiska.Programista);
        zespol1.dodajPracownika(p1);
        Pracownik pracownik1 = new Pracownik("A","A","@A","FirmaA",Stanowiska.Prezes);
        zespol2.dodajPracownika(pracownik1);
        assertThrows(IllegalArgumentException.class, () -> zespolManager.przeniesPracownika(p1,zespol1,zespol2));
